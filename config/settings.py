...
# Optional hotel metadata fallbacks (used only if DB site_settings is unavailable)
# HOTEL_NAME  = os.environ.get("HOTEL_NAME", "Your Hotel")
# HOTEL_PHONE = os.environ.get("HOTEL_PHONE", "")
HOTEL_NAME  = os.environ.get("HOTEL_NAME", "Your Hotel")
HOTEL_PHONE = os.environ.get("HOTEL_PHONE", "")

# Template strings for SMS — you can edit these without touching code.
# Available vars: {hotel}, {phone}, {code}, {room}, {check_in}, {check_out}
# SMS_TEMPLATES = {
#     "CHECKED_IN":  "{hotel}: Checked-in.\nCode: {code} | Room: {room}\nIn: {check_in}  Out: {check_out}",
#     "CHECKED_OUT": "{hotel}: Checked-out. Thanks for staying!\nCode: {code}",
#     "CANCELLED":   "{hotel}: Booking {code} cancelled.",
# }
...
SMS_TEMPLATES = {
    ...
    "CANCELLED":   "{hotel}: Booking {code} cancelled.",
    # ⬇️ NEW
    "RESERVED":    "{hotel}: Booking confirmed.\nCode: {code} | Room: {room}\nIn: {check_in}  Out: {check_out}",
}
